...
export NNODES=1
export MASTER_PORT=20954
export CPUS_PER_TASK=32

export SCRIPT_DIR=$(cd "$(dirname "$0")" && pwd)

# export TRAINING_DATASET_JSON=$SCRIPT_DIR/../../data_recipe/box.yaml
export TRAINING_DATASET_JSON=$SCRIPT_DIR/../../data_recipe/evalset250.yaml
# export TRAINING_DATASET_JSON=$SCRIPT_DIR/../../data_recipe/test.yaml

export TRAINING_NAME=Qwen2-0.5B-Siglip-Pretrain-Qwen2-0.5B-Stage2-0421test
...
#     --debug \
    ...
    # --model_name_or_path /mnt/petrelfs/chenjingzhou/cjz/MineruPrune/playground/training/training_dirs/Qwen2-0.5B-Siglip-Pretrain-Qwen2-0.5B-Stage2-0409prune-laglr0_2/checkpoint-2000 \
...
#     --cpus-per-task=$CPUS_PER_TASK \
#     --quotatype=spot \
#     -w SH-IDC1-10-140-24-15,SH-IDC1-10-140-24-85,SH-IDC1-10-140-24-87,SH-IDC1-10-140-24-22 \
srun -p mineru2_data \
    --nodes=$NNODES \
    --ntasks-per-node=1 \
    --gres=gpu:$GPUS_PER_NODE \
    ...
    --eval_data_path $SCRIPT_DIR/../../data_recipe/evalset_zh6k.yaml \
