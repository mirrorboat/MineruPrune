...
export TRAINING_DATASET_JSON=$SCRIPT_DIR/../../data_recipe/stage2_xyz-notes.yaml

export PRETRAIN_NAME=Qwen2-0.5B-Siglip-Pretrain-Qwen2-0.5B-Stage2-checkpoint-2-xyz_notes
export TRAINING_NAME=Qwen2-0.5B-Siglip-Pretrain-Qwen2-0.5B-Stage2-checkpoint-2-xyz_notes-1
