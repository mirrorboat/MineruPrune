...
export TRAINING_DATASET_JSON=$SCRIPT_DIR/../../data_recipe/stage2_exam-table.yaml

export PRETRAIN_NAME=Qwen2-0.5B-Siglip-Pretrain-Qwen2-0.5B-Stage2-checkpoint-2-continue-exam_table
export TRAINING_NAME=Qwen2-0.5B-Siglip-Pretrain-Qwen2-0.5B-Stage2-checkpoint-2-continue-exam_table-1
...
srun -p mineru2 \
    ...
    --kill-on-bad-exit=1 \
    -x SH-IDC1-10-140-24-29,SH-IDC1-10-140-24-66,SH-IDC1-10-140-24-68,SH-IDC1-10-140-24-79 \
