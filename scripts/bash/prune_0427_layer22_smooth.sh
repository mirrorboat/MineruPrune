...
export TRAINING_DATASET_JSON=$SCRIPT_DIR/../../data_recipe/box0425.yaml
# export TRAINING_DATASET_JSON=$SCRIPT_DIR/../../data_recipe/evalset_all_500.yaml

export TRAINING_NAME=Qwen2-0.5B-Siglip-Pretrain-Qwen2-0.5B-Stage2-0427layer22_smooth
...
srun -p mineru2_data \
    ...
    --cpus-per-task=$CPUS_PER_TASK \
    --quotatype=spot \
    -w SH-IDC1-10-140-24-48,SH-IDC1-10-140-24-21,SH-IDC1-10-140-24-117 \
