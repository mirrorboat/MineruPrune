...
export PRETRAIN_NAME=Opt-150M-Sam-HHD-Base-Pretrain-checkpoint-2
export TRAINING_NAME=Opt-150M-Sam-HHD-Base-Pretrain-Qwen1.5-0.5B-Stage2-checkpoint-2
