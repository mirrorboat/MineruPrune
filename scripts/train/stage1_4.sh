...
export TRAINING_NAME=Qwen2.5-0.5B-Sam-Large-Pretrain-checkpoint-2
...
srun -p mineru2 \
    ...
    --kill-on-bad-exit=1 \
    -x SH-IDC1-10-140-24-59,SH-IDC1-10-140-24-62,SH-IDC1-10-140-24-67,SH-IDC1-10-140-24-97 \
    --job-name sam_vit_large \
    ...
    --model_name_or_path $SCRIPT_DIR/../../playground/model/Qwen2.5-0.5B-Instruct \
    --version plain \
    --data_path $TRAINING_DATASET_JSON \
    --vision_tower $SCRIPT_DIR/../../playground/model/sam-vit-large \
