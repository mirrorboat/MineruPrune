...
export PRETRAIN_NAME=Qwen2.5-0.5B-Sam-Large-Pretrain-checkpoint-2
export TRAINING_NAME=Qwen2.5-0.5B-Sam-Large-Pretrain-Qwen1.5-0.5B-Stage2-checkpoint-2
