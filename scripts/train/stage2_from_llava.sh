...
export TRAINING_DATASET_JSON=$SCRIPT_DIR/../../data_recipe/stage2_all.yaml

export PRETRAIN_NAME=Qwen2-0.5B-Siglip-Pretrain-checkpoint-1
export TRAINING_NAME=Qwen2-0.5B-Siglip-Pretrain-Qwen2-0.5B-Stage2-checkpoint-3
