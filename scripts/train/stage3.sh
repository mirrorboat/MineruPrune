...
export TRAINING_DATASET_JSON=$SCRIPT_DIR/../../data_recipe/stage3.yaml

export PRETRAIN_NAME=Qwen-0.5B-Sam-Base-Stage2
export TRAINING_NAME=Qwen-0.5B-Sam-Base-Stage3
