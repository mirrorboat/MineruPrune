...
class PruningArguments:
    ...
    # pruning_modules: list = ["intermediate","layer","hidden"]
    ...
    eval_target_model: bool = True # important
...
path="/mnt/petrelfs/chenjingzhou/cjz/MyMinerU-LVLM/playground/training/training_dirs/Qwen2-0.5B-Siglip-0311-prune_from_scratch_0331_lag_lr1e-1/checkpoint-1900"

model = LlavaQwenForCausalLM.from_pretrained(path)
# breakpoint()
...
torch.save(model_state_dict, "pytorch_model0331.bin")
