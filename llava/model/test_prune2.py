...
path="/mnt/petrelfs/chenjingzhou/cjz/MineruPrune/playground/training/training_dirs/Qwen2-0.5B-Siglip-Pretrain-Qwen2-0.5B-Stage2-0427layer22/checkpoint-1000"
...
torch.save(model_state_dict, "pytorch_model0425.bin")
